...
class ContainerTestMixin:
    ...
    def assertInContainer(
        self,
        item: Any,
        container: Union[List[Any], Set[Any], Dict[Any, Any]],
    ...
    def assertContainerNotContains(
        self,
        unexpected_items: List[Any],
        container: Union[List[Any], Set[Any], Dict[Any, Any]],
    ) -> None:
        """
    ...
    def assertContainerEmpty(
        self, container: Union[List[Any], Set[Any], Dict[Any, Any]]
    ) -> None:
        """
    ...
    def assertContainerNotEmpty(
        ...
        """
        self.assertGreater(
            len(container), 0, "Container is empty but should not be"
        )

    def assertContainerSubset(
        self,
        expected_subset: Union[List[Any], Set[Any]],
        container: Union[List[Any], Set[Any], Dict[Any, Any]],
    ) -> None:
        """
        ...
        self.assertTrue(
            expected_items.issubset(container_items),
            f"Container does not contain expected subset: {expected_items}",
        )

    def assertContainerSuperset(
        self,
        expected_superset: Union[List[Any], Set[Any]],
        container: Union[List[Any], Set[Any], Dict[Any, Any]],
    ) -> None:
        """
        ...
        self.assertTrue(
            container_items.issubset(expected_items),
            f"Container is not a subset of expected superset: {container_items}",
        )

    def assertContainerEquals(
        self,
        expected_container: Union[List[Any], Set[Any], Dict[Any, Any]],
        actual_container: Union[List[Any], Set[Any], Dict[Any, Any]],
    ) -> None:
        """
        ...
        """
        if isinstance(expected_container, dict) and isinstance(
            actual_container, dict
        ):
            self.assertEqual(
                set(expected_container.keys()),
                set(actual_container.keys()),
                "Container keys don't match",
            )
            for key in expected_container:
                self.assertEqual(
                    expected_container[key],
                    actual_container[key],
    ...
    def assertContainerOrder(
        self, expected_order: List[Any], container: List[Any]
    ) -> None:
        """
    ...
    def assertContainerSorted(
        self, container: List[Any], reverse: bool = False
    ) -> None:
        """
        ...
        self.assertEqual(
            container, sorted_items, f"Container is not sorted: {container}"
        )

    def assertContainerFiltered(
        self,
        container: Union[List[Any], Set[Any]],
    ...
    def assertContainerMapped(
        self,
        container: Union[List[Any], Set[Any]],
        map_function: Callable[[Any], Any],
        expected_results: Union[List[Any], Set[Any]],
    ) -> None:
        """
        ...
        for i, (expected, actual) in enumerate(
            zip(expected_list, actual_results)
        ):
            self.assertEqual(
                expected,
                actual,
    ...
    def assertContainerAll(
        ...
        for item in container:
            self.assertTrue(
                predicate(item), f"Item '{item}' does not satisfy predicate"
            )

    def assertContainerAny(
        self,
        container: Union[List[Any], Set[Any]],
        predicate: Callable[[Any], bool],
    ) -> None:
        ...
        self.assertTrue(
            satisfied, f"No item in container satisfies predicate: {container}"
        )

    def assertContainerNone(
        self,
        container: Union[List[Any], Set[Any]],
        predicate: Callable[[Any], bool],
    ) -> None:
    ...
    def assertContainerMin(
        self, expected_min: Any, container: Union[List[Any], Set[Any]]
    ) -> None:
        """
    ...
    def assertContainerMax(
        self, expected_max: Any, container: Union[List[Any], Set[Any]]
    ) -> None:
        """
    ...
    def assertContainerSum(
        self, expected_sum: Any, container: Union[List[Any], Set[Any]]
    ) -> None:
        """
    ...
    def assertContainerAverage(
        self, expected_average: float, container: Union[List[Any], Set[Any]]
    ) -> None:
        """
    ...
    def assertContainerIntersection(
        self,
        container1: Union[List[Any], Set[Any]],
        container2: Union[List[Any], Set[Any]],
        expected_intersection: Union[List[Any], Set[Any]],
    ) -> None:
        """
    ...
    def assertContainerUnion(
        self,
        container1: Union[List[Any], Set[Any]],
        container2: Union[List[Any], Set[Any]],
        expected_union: Union[List[Any], Set[Any]],
    ) -> None:
        """
    ...
    def assertContainerDifference(
        self,
        container1: Union[List[Any], Set[Any]],
        container2: Union[List[Any], Set[Any]],
        expected_difference: Union[List[Any], Set[Any]],
    ) -> None:
        """
    ...
    def assertContainerSymmetricDifference(
        self,
        container1: Union[List[Any], Set[Any]],
        container2: Union[List[Any], Set[Any]],
        expected_symmetric_difference: Union[List[Any], Set[Any]],
    ) -> None:
        """
    ...
    def assertContainerInvariant(
        self,
        invariant_condition: Callable[
            [Union[List[Any], Set[Any], Dict[Any, Any]]], bool
        ],
        container: Union[List[Any], Set[Any], Dict[Any, Any]],
    ) -> None:
        """
